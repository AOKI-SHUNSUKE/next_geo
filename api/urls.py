...
from api.views import TaskViewSet, CreateUserView, TaskListView, TaskRetrieveView, PostListView, PostRetrieveView, \
    CoordinateListView, CoordinateRetrieveView, CoordinateViewSet
...
urlpatterns = [
    ...
    path('list-coordinate/', CoordinateListView.as_view(), name='list-coordinate'),
    path('detail-coordinate/<str:pk>/', CoordinateRetrieveView.as_view(), name='detail-coordinate'),
